...
workflow engine in Ruby.

## 🚀 Overview
This repository contains a professional implementation of **Ruby Workflow Engine**. It is designed with clean code principles and focuses on functionality and reliability.
